    ...
    <div class="row g-4 mb-4">
      <div class="col-md-4">
        <div class="card card-custom p-4">
          ...
          <a href="users.php" class="btn btn-orange w-100">Go</a>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card card-custom p-4">
          ...
          <a href="couriers.php" class="btn btn-orange w-100">Go</a>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card card-custom p-4">
          ...
          <a href="customers.php" class="btn btn-orange w-100">Go</a>
        </div>
      </div>
    </div>
    ...
    <div class="row g-4 mb-4">
      ...
      <div class="col-md-6">
        <div class="card card-custom p-4">
          ...
          <a href="shipments.php" class="btn btn-orange w-100">Go</a>
        </div>
      </div>
      <!-- <div class="col-md-4">
        <div class="card card-custom p-4">
